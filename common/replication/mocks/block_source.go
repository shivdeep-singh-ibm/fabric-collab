...
import (
	...
	replication "github.com/hyperledger/fabric/common/replication"

	mock "github.com/stretchr/testify/mock"
)

// BlockSource is an autogenerated mock type for the BlockSource type
type BlockSource struct {
	mock.Mock
}

// Close provides a mock function with given fields:
func (_m *BlockSource) Close() {
	_m.Called()
}

// PullBlock provides a mock function with given fields: seq
func (_m *BlockSource) PullBlock(seq uint64) *common.Block {
	ret := _m.Called(seq)
...
func (_m *BlockSource) UpdateEndpoints(endpoints []replication.EndpointCriteria) {
	_m.Called(endpoints)
}
